...
test('should loads jobs', async () => {
  ...
  //   expect(axios.get).toHaveBeenCalledWith('/jobs?query=&type=')

  // Wait until the DOM updates.
  //   await flushPromises()

  //   await wrapper.setData({ jobs: mockJobList })
...
//   axiosMock.onGet(`http://localhost:8080/api/jobs?query=&type=`).reply(200, [])
