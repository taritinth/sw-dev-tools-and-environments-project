<template>
  <div>
    ...
    <div class="relative px-4 w-full h-full md:h-auto">
      <!-- Modal content -->
      <div class="relative rounded-xl shadow dark:bg-gray-700 bg-gray-50 pb-6">
        ...
        <div
          ...
          class="flex flex-col pb-5 pt-0 text-center px-2 sm:px-8"
        >
          <!-- first box -->
          <div
          ...
          >
            ...
            <div class="flex flex-col flex-1 items-start justify-start mt-9">
              <div class="flex flex-col md:flex-row w-full justify-between">
                ...
                <div
                  class="flex flex-row mt-2 md:mt-0 md:flex-col md:items-end"
                >
                  <div
                    class="w-24 text-gray-700 px-6 py-2 text-sm leading-5 rounded-2xl capitalize"
                    :class="{
