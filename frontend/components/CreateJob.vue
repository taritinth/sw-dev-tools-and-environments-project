<template>
  <!-- Modal -->
  <!-- <div
    class="flex flex-col justify-center relative w-full bg-gray-500"
  ...
  >
    ...
    <div class="flex flex-col flex-auto text-left overflow-y-auto">
        ...
        <div class="w-full">
          <div class="mb-6">
            ...
            <template v-if="$v.title.$error">
              <p v-if="!$v.title.required" class="mt-2 text-sm text-red-400">
        ...
        <div class="w-full">
          <div class="mb-6">
            ...
            <template v-if="$v.overview.$error">
              <p v-if="!$v.overview.required" class="mt-2 text-sm text-red-400">
                This field is required
              </p>
            </template>
          </div>
        ...
        <div class="grid xl:grid-cols-3 xl:gap-6">
          <div class="mb-6">
            ...
            <template v-if="$v.dueDate.$error">
              <p v-if="!$v.dueDate.required" class="mt-2 text-sm text-red-400">
                This field is required
              </p>
            </template>
          </div>
          <div class="mb-6">
            ...
            <template v-if="$v.salary.$error">
              <p v-if="!$v.salary.required" class="mt-2 text-sm text-red-400">
                This field is required
              </p>
            </template>
          </div>
      ...
      >
        ...
        <div class="flex flex-col items-start w-full overflow-auto">
          <client-only>
            <quill-editor
              ref="editor"
              v-model="description"
