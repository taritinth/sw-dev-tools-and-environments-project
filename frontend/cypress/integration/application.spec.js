describe('JobJab', () => {
    it('End to End Test - JobJab Application', () => {
      ...
      cy.get('[data-test="email-input"]').should('have.value', 'applicant2@gmail.com')
      cy.get('[data-test="phone-input"]').should('have.value', '099999999')
      cy.get('[data-test="education-input"]').should('have.value', "King Mongkut's Institute of Technology Ladkrabang")
      cy.get('button[type=submit]').click();
